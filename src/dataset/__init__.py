...
__data_args = {
    'ntu-xsub': {'class': 60, 'shape': [1, 6, 288, 25, 2], 'Ad_shape': [25, 25], 'feeder': NTU_Feeder},
    'ntu-xview': {'class': 60, 'shape': [1, 6, 288, 25, 2], 'Ad_shape': [25, 25], 'feeder': NTU_Feeder},
    'ntu-xsub120': {'class': 120, 'shape': [1, 6, 288, 25, 2], 'Ad_shape': [25, 25], 'feeder': NTU_Feeder},
    'ntu-xset120': {'class': 120, 'shape': [1, 6, 288, 25, 2], 'Ad_shape': [25, 25], 'feeder': NTU_Feeder},
}
...
def create(dataset, root_folder, transform, num_frame, inputs, **kwargs):
    ...
    try:
        ...
        data_args['shape'][0] = len(inputs)  # 3个branch
    ...
    return feeders, data_args['shape'], data_args['Ad_shape'], data_args['class'], graph.A, graph.parts
